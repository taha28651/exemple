...
public interface GenericDao<T, PK> {
	...
	List<T> getEntityByColValue(String pColName, String pColVal, Long pClassName);
	List<T> getEntityByColValue2(String pColName, String pColVal, String pClassName,String pColName2, String pColVal2);
	T getEntity(String pColName, String pColVal, String pClassName,String pColName2, String pColVal2);
